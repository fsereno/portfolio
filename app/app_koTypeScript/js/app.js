...
/***/ "../typeScript/Services/validatorService.ts":
/*!**************************************************!*\
  !*** ../typeScript/Services/validatorService.ts ***!
  \**************************************************/
...
eval("\"use strict;\";\n\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar ValidatorService = /** @class */ (function () {\n    function ValidatorService() {\n        jQuery.validator.addMethod(\"nonNumeric\", function (value, element) {\n            return this.optional(element) || isNaN(Number(value));\n        });\n    }\n    ValidatorService.prototype.ValidateForm = function (formId, options) {\n        var validator = jQuery(\"#\" + formId).validate(options);\n        return validator;\n    };\n    return ValidatorService;\n}());\nexports.ValidatorService = ValidatorService;\n\n\n//# sourceURL=webpack:///../typeScript/Services/validatorService.ts?");

/***/ }),

/***/ "./typeScript/Models/StatusLiterals.ts":
/*!*********************************************!*\
  !*** ./typeScript/Models/StatusLiterals.ts ***!
  \*********************************************/
/*! no static exports found */
...
eval("\"use strict;\";\n\"use strict\";\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar component_1 = __webpack_require__(/*! ./components/component */ \"./typeScript/components/component.ts\");\nvar validatorService_1 = __webpack_require__(/*! ../../typeScript/Services/validatorService */ \"../typeScript/Services/validatorService.ts\");\nvar validatorService = new validatorService_1.ValidatorService();\nvar component = new component_1.Component(validatorService);\ncomponent.init();\n\n\n//# sourceURL=webpack:///./typeScript/app.ts?");

/***/ }),

/***/ "./typeScript/components/component.ts":
/*!********************************************!*\
  !*** ./typeScript/components/component.ts ***!
  \********************************************/
/*! no static exports found */
