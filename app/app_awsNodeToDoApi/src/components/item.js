            ...
            <ListGroup.Item variant={item.done ? "dark" : "" } className="d-flex justify-content-between align-items-center">
                ...
                {!item.done &&
                    <ButtonGroup aria-label="Basic example">
                        <Button className="bg-dark btn btn-sm px-1 text-white border-0" size="sm" onClick={_doneOnClick}>
                ...
                {item.done &&
                    <Button className="bg-dark btn btn-sm px-1 text-white border-0" size="sm" disabled>
